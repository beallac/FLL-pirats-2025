...
def run(base_robot):
    ...
    br.turnInPlace(angle=-25, speedPct=60, waiting=True)
    br.moveLeftAttachmentMotorForDegrees(degrees=940, speedPct=60)  # Open claw
    # Turn 21 degrees
    br.turnInPlace(angle=21, speedPct=60, waiting=True)
    # Drive 11 cm (110 mm)
