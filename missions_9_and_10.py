...
def run(br: BaseRobot):
    ...
    br.driveForDistance(distance=105, speedPct=80, waiting=True)
    br.turnInPlace(angle=-89, speedPct=45, waiting=True)
    br.driveForDistance(distance=190, speedPct=80, waiting=True)
    br.driveForDistance(distance=-190, speedPct=80, waiting=True)
